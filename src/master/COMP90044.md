...
- assemble a good research argument
  - try to plan argument early in supporting answers to the research questions
  - acknowledge and respond to alternatives/complications/objections
  - use warrants  to justify relevance of reasons to the claims
  - determine what kind of claim to make and br clear about it

## 10. Research Planning

- clarify aims and objectives
  - aim board, objective specific
  - SMART (Specific, Measurable, Achievable, Relevant, Time-bound)
- clarify milestones and deliverables
  - milestones: significant events, indicate completion of a phase, non-tangible
...
- risks
  ...
  - cases
    ...
    - stakeholder
    - external
- intellectual properties (IP) 知识产权
